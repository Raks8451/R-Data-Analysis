...
#Example
advertising <- read.csv("csv_connection.csv", stringsAsFactors = F)
str(advertising)
advertising <- read.csv("csv_connection.csv", stringsAsFactors = T)
str(advertising)
...
xml_demo <- xmlParse(file = "xml_demo.xml")
...
xmldataframe <- xmlToDataFrame("xml_demo.xml")
